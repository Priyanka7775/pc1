package com.question.UserAuthenticationService.rabbitmqreceiver;
...
public class Consumer {
    ...
    public void getDtoFromQueueAndAddToDb(UserDTO userDTO)throws UserAlreadyExistsException{
        User user=new User();
